...
class TwitterClient(object): 
	...
	def get_tweets(self, query, geocode, count = 10): 
		...
		try: 
			...
			fetched_tweets = self.api.search(q = query, result_type="recent", count = count, geocode = geocode) 
...
def main(): 
	...
	tweets = api.get_tweets(query = 'pineapple on pizza', geocode="51.509865,-0.118092,100km", count = 400) 
